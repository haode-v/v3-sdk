...
var SwapRouter = /*#__PURE__*/function (_SelfPermit) {
  ...
  SwapRouter.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var mustRefund = trade.inputAmount.currency.isNative && trade.tradeType === sdkCore.TradeType.EXACT_OUTPUT; // flags for whether funds should be send first to the router
